              ...
              currentIndex == 2
                  ? Padding(
                      ...
                      child: CustomFlatButton(
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => TouchFingerView()));
                          }),
                    )
                  : Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 24),
                      child: PrimaryButton(
                        onTap: () {
                          setState(() {
                            pageController.animateToPage(2, duration: const Duration(milliseconds: 1000), curve: Curves.fastOutSlowIn);
                          });
                        },
                        text: 'Skip',
                      ),
